...
import { ComputeServerlessFunctionInputSchemaInput } from 'src/engine/core-modules/workflow/dtos/compute-serverless-function-input-schema-input.dto';
...
export class WorkflowBuilderResolver {
  ...
  async computeServerlessFunctionInputSchema(
    ...
    return this.workflowBuilderWorkspaceService.computeServerlessFunctionInputSchema(
      {
        serverlessFunctionId,
        serverlessFunctionVersion,
        workspaceId,
